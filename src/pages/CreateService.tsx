...
const CreateService = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      const response = await fetchWithAuth('http://localhost:4000/api/v2/services', {
        method: 'POST',
        ...
        switch (errorData?.internalErrorCode) {
          ...
          case 1002:
            toaster.create({
              ...
              description: "Revisá los campos numéricos, booleanos y los días/hora.",
              type: "error",
              duration: 3000,
            });
            break;
    ...
    <Box p={6} color="white" bg="white" py={0}>
      ...
      />
        ...
        <FormControl>
          ...
          <Textarea placeholder="Escribe aquí..." bg="gray.100" minH="160px" color="gray.800" onChange={(e) => setDescription(e.target.value)} />
        </FormControl>
