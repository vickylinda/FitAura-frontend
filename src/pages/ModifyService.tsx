    ...
    const fetchService = async () => {
      ...
      try {
        ...
        for (const day in data.timeAvailability) {
          ...
          formattedSchedule[capitalizedDay] = data.timeAvailability[day].map(
        ...
        switch (errorData?.internalErrorCode) {
          ...
          case 1002:
            toaster.create({
              ...
              description:
                errorData.message ||
                "Revisá que el ID, duración, precio, capacidad y horarios sean correctos.",
              type: "error",
              duration: 3000,
            });
            break;
          ...
          case 1003:
            toaster.create({
              ...
              description:
                errorData.message ||
                "No tenés permisos para editar este servicio o hay un problema con los horarios.",
              type: "error",
              duration: 3000,
            });
            break;
    ...
    return (
      ...
      >
        <Text mb={6} fontSize="lg" color="#fd6193" fontWeight="medium">
          Cargando página para modificar servicio...
        </Text>
    ...
    <Box minH="100vh" bg="white" overflowX="hidden">
      ...
      <Box px={{ base: 4, md: 12 }} py={6} maxW="100%" mx="auto">
        ...
        <Text mb={8} color="gray.600" fontSize="md">
          Para modificar este servicio, se requiere completar los siguientes
          campos:
        </Text>
