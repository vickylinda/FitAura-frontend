...
const ChooseServiceToPublish = () => {
  ...
  const fetchServices = async (trainerId: number) => {
    const res = await fetch(`http://localhost:4000/api/v2/services?trainerId=${trainerId}&&published=false`);
  ...
  return (
    <Box minH="100vh" w="100vw" bg="white" px={{ base: 4, md: 10 }} py={{ base: 4, md: 6 }}>
      ...
      <Flex direction="column" mt={2} mb={2} gap={2}>
        <Text color="#fd6193" fontWeight="bold" fontSize="2xl">Seleccione el servicio a publicar</Text>
      </Flex>
